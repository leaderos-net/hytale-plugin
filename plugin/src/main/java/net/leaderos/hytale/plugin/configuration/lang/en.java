package net.leaderos.hytale.plugin.configuration.lang;
...
public class en extends Language {
    ...
    public static class Messages extends Language.Messages {
        ...
        public static class Discord extends Language.Messages.Discord {
             ...
             * Command Message
             */
            private String commandMessage = "{prefix} <link:{link}>&aClick here to sync your account with Discord!</link>";
