package net.leaderos.hytale.shared.helpers;
...
public class PluginUpdater {
    ...
    public PluginUpdater(String currentVersion) {
        try {
            this.url = new URL("https://api2.leaderos.net/plugin-version-check.php?plugin=hytale_leaderos&version=" + currentVersion);
